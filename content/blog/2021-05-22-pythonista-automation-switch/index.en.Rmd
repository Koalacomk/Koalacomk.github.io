...
<div class = "row">
<div class = "col-md-6">
We,programmers, always seek for practicality in our life, whether in our personal or professional environment we always look for improvements of our daily activities. One of the main automation in the market that impact our personal lives is the **Smart house** or **Home Automation**, which consists of automating or monitoring our domestic tasks and environments using internet connectivity and integrated systems.
<br />
...
<div class = "row">
<div class = "col-md-6">
***[SmartLife app](https://apps.apple.com/cr/app/smart-life-smart-living/id1115101477)*** connects to many devices and provides interfaces to operate each one of them. To establish the connection, just make sure that your device is on the same network as your smartphone and that the network frequency is compatible with the device (some devices only work on the 2.4 Ghz frequency).

</div>
<div class = "col-md-6">
 O Aplicativo ***[SmartLife](https://apps.apple.com/cr/app/smart-life-smart-living/id1115101477)***  se conecta a diversos dispostivos e proporciona interfaces para operar cada um deles. Para estabelecer a conexão, somente se segure que seu dispositivo esteja na mesma rede que seu smartphone e que a frequência da rede seja compativel ao aparelho (alguns dispostivos apenas funcionan na frequencia 2.4 Ghz).  <br />
 </div>
</div>

![Smartlife App](img/02TUYA.PNG) ![Interface dor Smart Breaker](img/01TUYA.PNG)
...
<div class = "row">
<div class = "col-md-6">
***[Pythonista](https://apps.apple.com/us/app/pythonista-3/id1085978097)*** is an app that allows you to run Python on your SMartphone. It is paid (approximately $ 9.99) but is great for running some applications. It already has some packages installed but to install other packages it is necessary to install ***[stash package](https://github.com/ywangd/stash)*** that allows you to install other packages (follow the instructions on the link to install it). After installation, we will need another API to access Smart Break, ***[TinyTuya package](https://pypi.org/project/tinytuya/)***. With it we will have to access all SmartLife devices connected to the network and access some functions of it.
</div>
<div class = "col-md-6">
***[Pythonista](https://apps.apple.com/us/app/pythonista-3/id1085978097)*** é um app que te permite rodar Python em seu SMartphone. Ele é pago (aproximadamente U$ 9.99) mas é ótimo para rodar algumas aplicações. Ele já possui alguns pacotes instalados mas para instalar outros pacotes é necessário instalar o  ***[Pacote stash](https://github.com/ywangd/stash)*** que te permite instalar outros pacotes (siga as instruções no link para instala-lo). Após a instalação, vamos precisar outra API para acessar o Smart Break, **[Pacote TinyTuya](https://pypi.org/project/tinytuya/)** . Com ele vamos ter a acessar todos os dispositivos SmartLife conectados a rede e acessar algumas funções dele. 
  <br />
 </div>
</div>


>import tinytuya<br /><br />
...
if switch_state==False:<br />
    printmsg="\U0001F428 Acendendo Abajur \U0001F428..."<br />
else:<br />
    printmsg = "\U0001F428 Apagando Abajur \U0001F428..."<br />
print(printmsg)<br />
data = d.set_status(not switch_state)<br />
