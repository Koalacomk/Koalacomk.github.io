...
<div class = "row">
<div class = "col-md-6">
As Nações Unidas publicamente proporciona dados de diversos países e de sobre diversos temas em seu ***[website](http://data.un.org/)*** .Dados populacionais, educacionais, financeiros , trabalhistas, criminais e diversos outros são acessíveis. Para este exercício, vamos utilizar os dados de **Gastos por países para classificar países com o mesmo comportamento**.  
<br />
...
<div class = "row">
<div class = "col-md-6">
No código acima foi utilizado 5 cluster para serem criados. Infelizmente modelos hierarquicos não performam bem quando temos um grande número de indivíduos, como você pode visualizar abaixo:
</div>
<div class = "col-md-6">
In the code above, 5 clusters were used to be created. Unfortunately hierarchical models doesnt have a good performance when we have a large number of individuals, as you can see below:
</div>
</div>
